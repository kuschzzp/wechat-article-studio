...
![封面图：一句话描述封面画面](images/01-cover.png)

开场正文。先用一个具体场景把读者带进来，不要急着下定义。

## 第一个小标题

正文。

> 可以放一句读者心里的话，或者一个典型误区。

## 第二个小标题

正文。

![正文图：一句话描述正文图画面](images/02-scene.png)
...
链接规则：使用纯文本，不使用 Markdown 超链接；URL 保留 https:// 或 http://。
...
- 摘要：
- 首屏：
- 图片显示：不在图片下方额外显示文字说明，确认图片本身表达清楚。
